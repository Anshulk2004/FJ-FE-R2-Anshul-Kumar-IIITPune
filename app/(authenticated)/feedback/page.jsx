...
import { Star, Coins, MessageSquare, Check, Edit2 } from 'lucide-react';
            ...
            <div className="flex gap-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <Star
                  key={star}
                  className={`w-5 h-5 ${
                    star <= currentFeedback.rating ? 'text-yellow-400 fill-current' : 'text-gray-300'
                  }`}
                />
              ))}
            </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 pt-20">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">Ride Feedback</h1>
        <div className="space-y-4">
          {pastRides.map((ride) => (
